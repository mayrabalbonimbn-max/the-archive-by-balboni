...
| File | Role |
|---|---|
| `The Archive.html` | App shell — loads fonts, `tokens.css`, React/Babel, mounts the prototype inside the iOS frame with viewport scaling. |
...
| `app.jsx` | Navigation state machine, overlays, viewport scaling, Tweaks (accent color). |
